...
resource "aws_eks_cluster" "eks_development" {
  depends_on = [
    aws_iam_role_policy_attachment.eks-amazonEKSClusterPolicy, aws_vpc.main_vpc, aws_subnet.eks_private_subnet_development, aws_subnet.eks_public_subnet_development
  ]
